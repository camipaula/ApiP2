...
namespace APIPROYECTO1.Migrations
{
    ...
    [Migration("20231211025922_sinrelaciones")]
    partial class sinrelaciones
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIPROYECTO1.Models.DetalleCarrito", b =>
                {
                    ...
                    b.Property<int>("AccesoriosIdAccesorio")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccesoriosIdAccesorio");
            ...
            modelBuilder.Entity("APIPROYECTO1.Models.DetalleCarrito", b =>
                {
                    b.HasOne("APIPROYECTO1.Models.Accesorios", "Accesorios")
                        .WithMany()
                        .HasForeignKey("AccesoriosIdAccesorio")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
